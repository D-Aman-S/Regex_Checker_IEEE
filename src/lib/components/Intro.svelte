...
<div class="form1">
  <div class="input-group"></div>
    <textarea name="text" cols="40" rows="5" placeholder="Write your regex expression here.."></textarea>

</div>
<div class="empty"></div>
<div class="form2"><textarea name="text" cols="40" rows="5" placeholder="Write your string to test here.."></textarea></div>
